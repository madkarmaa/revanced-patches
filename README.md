...
My custom set of ReVanced patches.
...
The following patches are currently available in this repository:

| Patch          | Target App       | Target Package    | Description           |
| :------------- | :--------------- | :---------------- | :-------------------- |
| **Unlock Pro** | Niagara Launcher | `bitpit.launcher` | Unlocks Pro features. |
